          ...
          <div className="space-y-8 animate-on-scroll">
            ...
            <div className="relative w-full md:px-[10%]">
              <div className="w-full flex justify-center">
                <img src="/lovable-uploads/163078a8-b279-4ada-ba74-f1efa161ebdc.png" alt="Roman Siepelmeyer" className="w-full h-auto object-cover" style={{
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="animate-on-scroll text-center">
                  <div className="anaro-card p-8 h-full hover:border-anaro-lime/50 group">
                    ...
                    <p className="text-anaro-text-secondary leading-relaxed">Your teams intellectually understand AI's importance. They've read the articles, watched the demos. But translating that into Monday morning workflows? That's where they get stuck. Knowledge without application is frustrating.</p>
                  </div>
                </div>
